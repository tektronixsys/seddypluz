import { $ as Droplets, H as Layers, K as Heart, S as Ruler, X as Gem, b as Scale, h as ShieldCheck, u as Sparkles, y as Scissors } from "../_libs/lucide-react.mjs";
//#region node_modules/.nitro/vite/services/ssr/assets/data-CxlY3IqO.js
var hair_straight_default = "/assets/hair_straight-D-lzH_Qm.png";
var hair_wave_default = "/assets/hair_wave-BylvQg9I.png";
var hair_curl_default = "/assets/hair_curl-5Hm_HhN-.png";
var hair_bob_default = "/assets/hair_bob-BhTBbc_B.png";
var lipstick_default = "/assets/lipstick-CeOGnLO-.png";
var highlighter_default = "/assets/highlighter-BUAijgFw.png";
var brush_default = "/assets/brush-BzYU8gez.png";
var boutiqueProducts = [
	{
		id: "hair_straight",
		...
		fullDesc: "Engineered from 100% single-donor virgin remy hair, our signature Bone Straight unit delivers unmatched glass-like gloss and ultra-dense blunt ends. Each bundle undergoes cold-water cuticle sealing to prevent frizz, tangling, or heat degradation.",
		img: hair_straight_default,
		price: "₦280,000",
		...
		details: {
			...
			careTips: "Use lightweight silicone serum, avoid heavy mineral oils, store in silk packaging, flat iron at max 230°C."
		}
	},
	{
		id: "hair_wave",
		...
		fullDesc: "Sculpted with steam-textured natural deep waves, this unit stays moisturized, full of bounce, and defined all day. Whether worn wet with curl mousse or dry for Hollywood volume, the hair remains soft and silky to the touch.",
		img: hair_wave_default,
		price: "₦310,000",
		...
		details: {
			...
			careTips: "Spritz with water and leave-in conditioner daily, detangle with wide-tooth comb from tip to root."
		}
	},
	{
		id: "hair_curl",
		...
		fullDesc: "A ready-to-wear statement piece handcrafted for lightweight elegance and easy glueless wear. Features customized cap elasticity with ventilated ear tabs for flawless comfort throughout long wedding days and soirees.",
		img: hair_curl_default,
		price: "₦195,000",
		...
		details: {
			...
			careTips: "Air dry after washing, avoid brush detangling when completely dry to maintain curl cluster definition."
		}
	},
	{
		id: "hair_bob",
		...
		fullDesc: "Precision razor-cut in-house by Seddypluz master stylists. Bleached safely to pure honey and platinum blonde tones with intact cuticle strength, delivering runway-ready glamour straight out of the box.",
		img: hair_bob_default,
		price: "₦210,000",
		...
		details: {
			...
			careTips: "Wash with sulfate-free color-safe shampoo and apply argan oil sparingly to the ends."
		}
	},
	{
		...
		fullDesc: "Custom blended in our studio lab for bridal endurance. Infused with organic rosehip seed oil and hyaluronic spheres, this formula locks in saturated pigment that resists champagne sips, kisses, and long ceremony days without flaking.",
		img: lipstick_default,
		price: "₦38,000",
	...
	},
	{
		...
		fullDesc: "Crafted with baked Italian mineral pigments and light-refracting pearl crystals, this illuminator melts seamlessly into skin without highlighting texture, creating that coveted camera-luminous glass skin bridal glow.",
		img: highlighter_default,
		price: "₦55,000",
		...
		details: {
			...
			careTips: "Dust lightly on high points of cheeks, bridge of nose, collarbones, and décolletage."
		}
	},
	{
		...
		fullDesc: "The exact custom tool Seddypluz artists rely on for seamless base blending, sculptural cheekbone contouring, and luminous gele makeup application. Balanced weighted wooden handle with rose-gold ferrule.",
		img: brush_default,
		price: "₦42,000",
		...
		specs: [
			{
				icon: Sparkles,
				label: "Vegan Bristles"
			},
			{
				icon: Gem,
				label: "Rose-Gold Ferrule"
			},
			{
				icon: ShieldCheck,
				label: "Zero Shedding"
...
var PRODUCT_IMAGE_PRESETS = [
	{
		id: "straight",
		label: "Bone Straight Weave",
		value: hair_straight_default,
		category: "wigs"
	},
	{
		id: "wave",
		label: "Water Wave Curls",
		value: hair_wave_default,
		category: "wigs"
	},
	{
		id: "curl",
		label: "Pixie Bouncy Curl",
		value: hair_curl_default,
		category: "wigs"
	},
	{
		id: "bob",
		label: "Blunt Cut Silk Bob",
		value: hair_bob_default,
		category: "wigs"
	},
	{
		id: "lipstick",
		label: "Velvet Matte Lipstick",
	...
	},
	{
		...
		value: highlighter_default,
		category: "cosmetics"
	},
	{
		id: "brush",
		label: "Artistry Buffing Brush",
		value: brush_default,
		category: "cosmetics"
	}
];
function getStoredBoutiqueProducts() {
	...
	try {
		...
		return parsed.map((p) => {
			...
			if (defaultProduct && defaultProduct.specs) return {
				...p,
...
function saveStoredBoutiqueProducts(products) {
...
function resetStoredBoutiqueProducts() {
	if (typeof window === "undefined") return boutiqueProducts;
	try {
		localStorage.removeItem("seddypluz_boutique_products");
		window.dispatchEvent(new CustomEvent("seddypluz_inventory_updated", { detail: boutiqueProducts }));
	} catch (_error) {}
	return boutiqueProducts;
}
...
function saveStoredAnnouncements(announcements) {
	...
	try {
		...
		window.dispatchEvent(new CustomEvent("seddypluz_announcement_updated", { detail: {
			announcements,
			active
		} }));
	} catch (err) {
...
function getActiveAnnouncement() {
	return getStoredAnnouncements().find((a) => a.isActive) || null;
}
function resetStoredAnnouncements() {
	if (typeof window === "undefined") return defaultAnnouncements;
	try {
		localStorage.removeItem("seddypluz_announcements");
		window.dispatchEvent(new CustomEvent("seddypluz_announcement_updated", { detail: {
			announcements: defaultAnnouncements,
			active: defaultAnnouncements[0]
		} }));
	} catch (_error) {}
	return defaultAnnouncements;
}
//#endregion
export { getStoredBoutiqueProducts as a, resetStoredBoutiqueProducts as c, getStoredAnnouncements as i, saveStoredAnnouncements as l, boutiqueProducts as n, hair_wave_default as o, getActiveAnnouncement as r, resetStoredAnnouncements as s, PRODUCT_IMAGE_PRESETS as t, saveStoredBoutiqueProducts as u };
